...
import type { Navigator } from '../typeDefinitions';
...
function wrapScreen(screenName: string, fn: Function, navigator: Navigator): Component<Props, *> {
	class WrappedScreen extends Component<Props, void> {
		...
		render() {
			...
			return <RootComponent {...this.props} navigator={navigator} />
		}
	}
